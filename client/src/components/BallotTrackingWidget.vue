...
async function submitForm(event: any) {
  ...
  router.push(`/${route.params.locale}/${_electionSlug.value}/track/${_trackingCode.value}`);
}
...
<template>
  <Infobox class="BallotTrackingWidget">
    <form @submit="submitForm" class="BallotTrackingWidget__Form">
      <p :class="{ BallotTrackingWidget__Input: true, 'BallotTrackingWidget__Input--filled': _trackingCode }">
        <label for="ballot-tracking-code">
